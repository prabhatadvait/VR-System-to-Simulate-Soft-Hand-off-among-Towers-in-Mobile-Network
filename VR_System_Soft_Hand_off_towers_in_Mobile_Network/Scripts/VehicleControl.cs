...
public class VehicleControl : MonoBehaviour
{
    ...
    public class CarSetting
    {
        ...
        public float shiftDownRPM = 800.0f;
        public float shiftUpRPM = 1000.0f;
        public float idleRPM = 150.0f;
        ...
        public float LimitForwardSpeed =  40.0f;
...
// modify
public float speedDecreaseFactor = 0.98f;

// public float speedDecreaseFactor = 0.98f;
    void FixedUpdate()
    {
        // speed of car
        speed = myRigidbody.velocity.magnitude * 2.7f; //2.7f;
...
speed *= speedDecreaseFactor;
      ...
      //  carSetting.shiftCentre.x = -Mathf.Clamp(steer * (speed / 100), -0.03f, 0.03f);
        ...
        wantedRPM = (750f * accel) * 0.1f + wantedRPM * 0.7f;
    ...
    : slip = Mathf.Lerp(slip, 0.01f, 0.02f);
        ...
        if (motorRPM > 2500.0f) motorRPM = 2000.0f;
